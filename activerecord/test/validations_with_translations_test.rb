...
class ValidationsWithTranslationsTest < Test::Unit::TestCase
    ...
    Object.class_eval <<-ENDDEF
      class ::ActiveSupport::Translation::TranslatableString
        def self.overidden_translate(string, args)
          DefaultTranslatableString.translate(string, args) + ' translated'
        end
  ...
  def tear_down
   ...
   def test_single_attr_validation_and_error_msg
     ...
     assert_equal "Empty translated", r.errors.on("content"), "A reply without content should contain an error"
   ...
   def test_double_attr_validation_and_error_msg
     ...
     assert_equal "Empty translated", r.errors.on("title"), "A reply without title should contain an error"
   ...
   def test_error_on_create
     ...
     assert_equal "is Wrong Create translated", r.errors.on("title"), "A reply with a bad content should contain an error"
   end
   ...
   def test_error_on_update
     ...
     assert r.errors.invalid?("title"), "A reply with a bad title should mark that attribute as invalid"
     assert_equal "is Wrong Update translated", r.errors.on("title"), "A reply with a bad content should contain an error"
   end
   ...
   def test_single_error_per_attr_iteration
     ...
     assert errors.include?(["title", "Empty translated"])
     assert errors.include?(["content", "Empty translated"])
   end
   ...
   def test_multiple_errors_per_attr_iteration_with_full_error_composition
     ...
     assert_equal "Title is Wrong Create translated", errors[0]
     assert_equal "Title is Content Mismatch translated", errors[1]
     assert_equal 2, r.errors.count
   end
   ...
   def test_errors_on_base
     ...
     assert_equal "Reply is not dignifying translated", r.errors.on_base
     assert errors.include?("Title Empty translated")
     assert errors.include?("Reply is not dignifying translated")
     assert_equal 2, r.errors.count
   end
   ...
   def test_validates_each
     ...
     assert !t.save
     assert_equal 4, hits
     assert_equal ["gotcha translated","gotcha translated"], t.errors.on(:title)
     assert_equal ["gotcha translated","gotcha translated"], t.errors.on(:content)
   ensure
     perform = false
   end
   ...
   def test_terms_of_service_agreement
     ...
     assert !t.save
     assert_equal "must be accepted translated", t.errors.on(:terms_of_service)
   ...
   def test_eula
     ...
     assert !t.save
     assert_equal "must be abided translated", t.errors.on(:eula)
   ...
   def test_validate_presences
     ...
     t = Topic.create
     assert !t.save
     assert_equal "can't be blank translated", t.errors.on(:title)
     assert_equal "can't be blank translated", t.errors.on(:content)
   ...
   def test_validate_uniqueness
     ...
     assert_equal "has already been taken translated", t2.errors.on(:title)
   ...
   def test_validate_format
     ...
     assert_equal "is bad data translated", t.errors.on(:title)
   ...
   def test_validates_inclusion_of
     ...
     assert_equal "is not included in the list translated", t.errors["title"]
   ...
   def test_validates_length_of_using_minimum_plural
     ...
     assert !t.valid?
     assert t.errors.on(:title)
     assert_equal "is too short (minimum is 5 characters) translated", t.errors["title"]
   ...
   def test_validates_length_of_using_minimum_singular
     Topic.validates_length_of :title, :minimum => 1
     ...
     assert !t.valid?
     assert t.errors.on(:title)
     assert_equal "is too short (minimum is 1 character) translated", t.errors["title"]
   ...
   def test_validates_length_of_using_maximum_plural
     ...
     assert !t.valid?
     assert t.errors.on(:title)
     assert_equal "is too long (maximum is 5 characters) translated", t.errors["title"]
   ...
   def test_validates_length_of_using_maximum_singular
     Topic.validates_length_of :title, :maximum => 1

     t = Topic.create("title" => "v", "content" => "whatever")
     assert t.valid?

     t.title = "notvalid"
     assert !t.valid?
     assert t.errors.on(:title)
     assert_equal "is too long (maximum is 1 character) translated", t.errors["title"]
   ...
   def test_validates_length_of_using_within
     ...
     assert !t.valid?
     assert_equal "is too short (minimum is 3 characters) translated", t.errors.on(:title)
     assert_equal "is too long (maximum is 5 characters) translated", t.errors.on(:content)

     t.title = nil
     t.content = nil
     assert !t.valid?
     assert_equal "is too short (minimum is 3 characters) translated", t.errors.on(:title)
     assert_equal "is too short (minimum is 3 characters) translated", t.errors.on(:content)
   ...
   def test_optionally_validates_length_of_using_within_on_create
     ...
     assert !t.save
     assert t.errors.on(:title)
     assert_equal "my string is too long: 10 translated", t.errors[:title]
   ...
   def test_optionally_validates_length_of_using_within_on_update
     ...
     assert !t.save
     assert t.errors.on(:title)
     assert_equal "my string is too short: 5 translated", t.errors[:title]
   ...
   def test_validates_length_of_using_is
     ...
     assert !t.valid?
     assert t.errors.on(:title)
     assert_equal "is the wrong length (should be 5 characters) translated", t.errors["title"]
   ...
   def test_validates_length_with_globaly_modified_error_message
     ...
     assert_equal 'tu est trops petit hombre 10 translated', t.errors['title']
   end
   ...
   def test_validates_length_of_custom_errors_for_minimum_with_message
     ...
     assert !t.valid?
     assert t.errors.on(:title)
     assert_equal "boo 5 translated", t.errors["title"]
   end
   ...
   def test_validates_length_of_custom_errors_for_minimum_with_too_short
     ...
     assert !t.valid?
     assert t.errors.on(:title)
     assert_equal "hoo 5 translated", t.errors["title"]
   end
   ...
   def test_optionally_validates_length_of_using_within_on_create_utf8
     kcode_scope('UTF8') do
       ...
       assert !t.save
       assert t.errors.on(:title)
       assert_equal "長すぎます: 10 translated", t.errors[:title]
   ...
   def test_optionally_validates_length_of_using_within_on_update_utf8
     kcode_scope('UTF8') do    
       ...
       assert !t.save
       assert t.errors.on(:title)
       assert_equal "短すぎます: 5 translated", t.errors[:title]
   ...
   def test_validate_block
     ...
     assert !t.valid?
     assert t.errors.on(:title)
     assert_equal "will never be valid translated", t.errors["title"]
   end
   ...
   def test_validates_acceptance_of_with_custom_error_using_quotes
     ...
     d.salary = "0"
     assert !d.valid?
     assert_equal "This string contains 'single' and \"double\" quotes translated", d.errors.on(:salary).last
   end
   ...
   def test_validates_confirmation_of_with_custom_error_using_quotes
     ...
     assert !d.valid?
     assert_equal "confirm 'single' and \"double\" quotes translated", d.errors.on(:name)
   end
   ...
   def test_validates_format_of_with_custom_error_using_quotes
     ...
     assert !d.valid?
     assert_equal "format 'single' and \"double\" quotes translated", d.errors.on(:name)
   end
   ...
   def test_validates_length_of_with_custom_too_long_using_quotes
     ...
     d.name = "Jeffrey"
     assert !d.valid?
     assert_equal "This string contains 'single' and \"double\" quotes translated", d.errors.on(:name).last
   end
   ...
   def test_validates_presence_of_with_custom_message_using_quotes
     ...
     d.name = "Joe"
     assert !d.valid?
     assert_equal "This string contains 'single' and \"double\" quotes translated", d.errors.on(:non_existent)
   end
   ...
   def test_validates_associated_with_custom_message_using_quotes
     ...
     r.topic = Topic.create("title" => "uhohuhoh")
     assert !r.valid?
     assert_equal "This string contains 'single' and \"double\" quotes translated", r.errors.on(:topic).last
   end
   ...
   def test_errors_to_xml
     ...
     assert xml.include?("<error>Title is Wrong Create translated</error>")
     assert xml.include?("<error>Content Empty translated</error>")
   end
  ...
  def test_validation_order
     ...
     t = Topic.new("title" => "")
     assert !t.valid?
     assert_equal "can't be blank translated", t.errors.on("title").first
  end
...
class ValidatesNumericalityTest < Test::Unit::TestCase
  ...
  def test_validates_numericality_with_greater_than
    ...
    invalid!([-10, 10], 'must be greater than 10 translated')
    valid!([11])
  end
  ...
  def test_validates_numericality_with_greater_than_or_equal
    ...
    invalid!([-9, 9], 'must be greater than or equal to 10 translated')
    valid!([10])
  end
  ...
  def test_validates_numericality_with_equal_to
    ...
    invalid!([-10, 11], 'must be equal to 10 translated')
    valid!([10])
  end
  ...
  def test_validates_numericality_with_less_than
    ...
    invalid!([10], 'must be less than 10 translated')
    valid!([-9, 9])
  end
  ...
  def test_validates_numericality_with_less_than_or_equal_to
    ...
    invalid!([11], 'must be less than or equal to 10 translated')
    valid!([-10, 10])
  end
  ...
  def test_validates_numericality_with_odd
    ...
    invalid!([-2, 2], 'must be odd translated')
    valid!([-1, 1])
  end
  ...
  def test_validates_numericality_with_even
    ...
    invalid!([-1, 1], 'must be even translated')
    valid!([-2, 2])
  end
