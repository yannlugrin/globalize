ActiveRecord::Schema.define do
  ...
  create_table :multilingual_products, :force => true do |t|
  ...
  add_index :multilingual_products, :code, :unique
  add_index :multilingual_products, :manufacturer_id

  create_table :multilingual_manufacturers, :force => true do |t|
    t.column :code, :string
    t.column :name, :string
  end

  add_index :multilingual_manufacturers, :code, :unique

  create_table :multilingual_categories, :force => true do |t|
    t.column :code, :string
    t.column :name, :string
  end

  add_index :multilingual_categories, :code, :unique

  create_table :multilingual_categories_products, :id => false, :force => true do |t|
    t.column :category_id, :integer
    t.column :product_id, :integer
  end

  add_index :multilingual_categories_products, :category_id
  add_index :multilingual_categories_products, :product_id
