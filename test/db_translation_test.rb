...
class TranslationTest < Test::Unit::TestCase
  fixtures :multilingual_languages, :multilingual_translations, :multilingual_countries, 
    :multilingual_products, :multilingual_manufacturers, :multilingual_categories, 
    :multilingual_categories_products

  class Product < ActiveRecord::Base
    set_table_name "multilingual_products"

    has_and_belongs_to_many :categories, :join_table => "multilingual_categories_products"
  ...
  class Category < ActiveRecord::Base
    set_table_name "multilingual_categories"
    has_and_belongs_to_many :products, :join_table => "multilingual_categories_products"

    translates :name
  end

  class Manufacturer < ActiveRecord::Base
    set_table_name "multilingual_manufacturers"
    has_many :products
  ...
  def test_wrong_language
    ...
    Multilingual::Locale.set("en-US")
    assert_raise(Multilingual::WrongLanguageError) { prod.description }
    assert_raise(Multilingual::WrongLanguageError) { prod.save! }    
  end
