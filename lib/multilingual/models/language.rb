module Multilingual
  class Language < ActiveRecord::Base # :nodoc:
    set_table_name "multilingual_languages"

    validates_uniqueness_of :iso_639_1, :iso_639_2, :iso_639_3
    validates_presence_of :english_name
    validates_length_of :pluralization, :maximum => 200
    validates_format_of :pluralization, :with => /^[c=\d?:%!<>&|() ]+$/, 
    ...
    def plural_index(num)
      ...
      # stored formula is 1-based; convert to 0-based
      instance_eval(expr) - 1
    end
