...
=begin rdoc
  ...
  Example:
    ...
    class Product < ActiveRecord::Base
      composed_of :price, :class_name => "Multilingual::Currency", 
  ...
  class Currency
    ...
    def format(options = {})
      ...
      if options[:code]
        ...
        currency_code ? self.amount + " " + currency_code : self.amount
      else
    ...
    def amount
      return nil if na?
      decimal_sep = Locale.active.currency_decimal_sep || Locale.active.decimal_sep 
      dollar_part.to_s + decimal_sep + 
